...
@view_config(route_name='account_management', renderer='ptmscout:templates/accounts/account.pt', permission='private')
...
@view_config(route_name='change_password_success', renderer='ptmscout:templates/info/information.pt', permission='private')
