...
def upload_configure_dataset(request):
    ...
    return upload_configure.upload_config_handler( request, strings.dataset_upload_configure_page_title, request.route_url('dataset_confirm', id=session_id), mod_required=False )
